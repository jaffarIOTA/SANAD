...
export interface Obligation {
  ...
  /** Cumulative reductions from Board-approved waivers. Never negative. */
  readonly waivedAmount: Money;
...
export function applyEarlySettlementRelief(
   ...
   */
  revisedInstalments: readonly Instalment[],
  basis: { readonly configKey: string; readonly shariahApprovalId: string },
): Result<Obligation> {
...
export function applyPayment(obligation: Obligation, payment: Money): Result<Obligation> {
...
export function amountPayable(o: Obligation): Money {
  return subtract(o.totalAmount, o.waivedAmount);
}

export function outstanding(o: Obligation): Money {
