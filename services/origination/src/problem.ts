...
const ARABIC: Readonly<Record<string, string>> = {
  ...
  INFORMATION_REQUEST_EMPTY: 'حدِّد المطلوب؛ لا يمكن الرد على طلب بلا مضمون.',
  SERVICING_FAILURE_WITHOUT_REASON: 'سجِّل سبب تعذّر الوصول إلى نظام الخدمة.',
  SERVICING_RETRIES_EXHAUSTED: 'استُنفدت المحاولات التلقائية؛ يلزم إعادة الإرسال يدوياً من شخص مسمّى.',
  SERVICING_RETRY_TOO_SOON: 'لم تنقضِ فترة الانتظار بين المحاولات بعد.',
  MANUAL_RESUBMISSION_WITHOUT_NOTE: 'إعادة الإرسال اليدوية تتطلب بيان السبب.',
  RESUBMISSION_CHANGES_IDENTITY: 'الطلب المُعاد إرساله يحتفظ بمعرّفه ومؤسسته.',
  RESUBMISSION_CHANGES_CHANNEL: 'لا يمكن للطلب تغيير القناة التي ورد منها.',
  CONSENT_MISSING: 'لا توجد موافقة سارية من النوع المطلوب لهذا العميل.',
  RESOLUTION_REQUIRED: 'يُحلّ الاستثناء ببيان كيفية حلّه، لا بإغلاقه.',
