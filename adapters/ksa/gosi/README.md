...
**Port:** `core/ports/employment-verification.ts`. **Status:** `BLOCKED` — fixture transport only.
...
KSA-RAIL-GOSI-01 — the consent artefact the service requires, and whether salary is returned as a figure or a band.
