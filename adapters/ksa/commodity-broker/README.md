# Commodity broker — organised Tawarruq

**Port:** `core/ports/commodity-broker.ts`. **Status:** `BLOCKED` — fixture transport only.
...
KSA-RAIL-BROKER-01 — the board-approved broker’s API for purchase, title transfer and onward sale, and the evidence it issues for each.
