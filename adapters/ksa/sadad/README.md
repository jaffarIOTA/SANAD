...
**Port:** `core/ports/bill-collection.ts`. **Status:** `BLOCKED` — fixture transport only.
...
KSA-RAIL-SADAD-01 — the institution’s biller registration and the reconciliation feed format.
