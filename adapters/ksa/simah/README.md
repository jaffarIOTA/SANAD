...
**Port:** `core/ports/credit-bureau.ts`. **Status:** `BLOCKED` — fixture transport only.
...
KSA-RAIL-SIMAH-01 — the enquiry purpose codes, the consent reference format, and the reporting file/API cadence for new facilities.
