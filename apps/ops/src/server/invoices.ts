...
const DEVELOPMENT_INVOICES: readonly ClearedInvoice[] = [
  ...
  {
    invoiceUuid: '3cf5d9a2-0000-4000-8000-000000000105',
    invoiceNumber: '452255',
    invoiceHash: 'e5f60718293a4b5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4',
    issuerName: 'Al-Ufuq Materials Company Limited',
    issuerCr: '1010000002',
    recipientName: 'Najd Logistics Company',
    recipientCr: '1010000044',
    amount: money(13_600_000n),
    issuedGregorian: '22 September 2026',
    issuedHijri: '١٠ ربيع الآخر ١٤٤٨',
    goodsDescription: 'Aluminium cladding panels, 800 m²',
    goodsDescriptionAr: 'ألواح تكسية ألمنيوم، ٨٠٠ م²',
  },
  {
    invoiceUuid: '3cf5d9a2-0000-4000-8000-000000000106',
    invoiceNumber: '452268',
    invoiceHash: 'f60718293a4b5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5',
    issuerName: 'Bahr Al-Khaleej Shipping Establishment',
    issuerCr: '1010000077',
    recipientName: 'Tamam Foodstuff Trading Company',
    recipientCr: '7001000019',
    amount: money(6_900_000n),
    issuedGregorian: '23 September 2026',
    issuedHijri: '١١ ربيع الآخر ١٤٤٨',
    goodsDescription: 'Cold-chain pallets, 400 units',
    goodsDescriptionAr: 'منصات تبريد، ٤٠٠ وحدة',
  },
  {
    invoiceUuid: '3cf5d9a2-0000-4000-8000-000000000107',
    invoiceNumber: '452279',
    invoiceHash: '0718293a4b5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5f6',
    issuerName: 'Najd Logistics Company',
    issuerCr: '1010000044',
    recipientName: 'Rawabi Industrial Supplies Establishment',
    recipientCr: '7001000001',
    amount: money(37_400_000n),
    issuedGregorian: '24 September 2026',
    issuedHijri: '١٢ ربيع الآخر ١٤٤٨',
    goodsDescription: 'Diesel generator sets, 3 units',
    goodsDescriptionAr: 'مولدات ديزل، ٣ وحدات',
  },
  {
